...
const PUBLIC_PACKAGE_SIGNALS = ['repository', 'homepage', 'bugs'];
export function analyzeDepConfusion(context) {
    const findings = [];
    ...
    const missingPublicFields = PUBLIC_PACKAGE_SIGNALS.filter((field) => !versionMeta[field] &&
        !packument[field]);
    ...
    findings.push({
        ...
        description: `'${packageName}' matches patterns common in internal/private package naming and has multiple ` +
...
//# sourceMappingURL=dep-confusion.js.map