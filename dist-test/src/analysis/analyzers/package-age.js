...
export async function analyzePackageAge(context) {
    const findings = [];
    ...
    if (downloads !== null && downloads < LOW_DOWNLOAD_THRESHOLD) {
        findings.push({
            ...
            description: `'${packageName}' was published ${Math.round(ageDays)} days ago and has only ${downloads} ` +
        ...
        findings.push({
            ...
            description: `'${packageName}' was published only ${Math.round(ageDays)} days ago. ` +
...
//# sourceMappingURL=package-age.js.map