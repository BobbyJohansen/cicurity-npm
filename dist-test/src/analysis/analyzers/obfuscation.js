...
import { parseScript, walkAst, shannonEntropy } from '../ast-utils.js';
...
export function analyzeObfuscation(context) {
    const findings = [];
...
function isBufferFromBase64(node) {
