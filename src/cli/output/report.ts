...
import type { PackageAnalysisResult, CicurityReport, ReportPackage, PackageState } from '../../analysis/types.js';
...
function toState(action: PackageAnalysisResult['action']): PackageState {
...
export function resolveProjectName(explicitName?: string): string {
...
function resolveCicurityVersion(): string {
  try {
...
export function buildReport(
  ...
  const packages: ReportPackage[] = results.map((r): ReportPackage => {
...
export function writeAnalyzerReport(
  results: PackageAnalysisResult[],
  resolvedPackages: Map<string, ResolvedPackage>,
  projectName: string,
): void {
