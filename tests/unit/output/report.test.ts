...
import type { PackageAnalysisResult } from '../../../src/analysis/types.js';
import type { ResolvedPackage } from '../../../src/registry/types.js';

function makeResult(overrides: Partial<PackageAnalysisResult> = {}): PackageAnalysisResult {
  return {
    packageName: 'express',
    version: '4.18.2',
...
function makeResolved(name: string, version: string, publishedAt?: string): ResolvedPackage {
  return {
    name,
    version,
