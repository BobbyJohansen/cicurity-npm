...
function makePackument(versions: Record<string, string>, name = 'test-pkg'): Packument {
  const versionMetas: Record<string, {
    name: string; version: string; dist: { integrity: string; tarball: string }; maintainers: [];
  }> = {};
